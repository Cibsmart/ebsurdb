...
<body>
<div style="font-size:20px; font-family:Arial, Helvetica, sans-serif; font-weight:bolder; text-align:center; margin:auto; padding:20px">VIEW LIST OF STUDENTS</div>
...
<form id="form1" name="form1" method="post" action="dostudentlist.php" target="_blank">
  <table width="550" border="0" cellpadding="2" cellspacing="5">
    ...
    <tr>
      <td class="aa">Year of Admission:</td>
      <td class="ab">
    ...
    <tr>
      <td colspan="2" align="center"><input type="button" name="buton" id="buton" value="View List" onclick="processStdList()" /></td>
      </tr>
  </table>
