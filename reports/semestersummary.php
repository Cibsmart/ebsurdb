...
<body>
<div style="font-size:20px; font-family:Arial, Helvetica, sans-serif; font-weight:bolder; text-align:center; margin:auto; padding:20px">SEMESTER SUMMARY</div>
...
<form id="form1" name="form1" method="post" action="doSemesterSummary.php" target="_blank">
  <table width="550" border="0" cellpadding="2" cellspacing="5">
    <tr>
      <td class="aa">Faculty:</td>
      <td class="ab">
