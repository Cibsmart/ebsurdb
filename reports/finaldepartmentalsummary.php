...
<title>Final Departmental Summary</title>
...
<body>
<div style="font-size:20px; font-family:Arial, Helvetica, sans-serif; font-weight:bolder; text-align:center; margin:auto; padding:20px">FINAL DEPARTMENTAL SUMMARY</div>
...
<form id="form1" name="form1" method="post" action="dofinaldepartmentalsummary.php" target="_blank">
