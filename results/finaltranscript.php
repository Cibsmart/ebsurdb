<?php 
	session_start();
	if((isset($_SESSION['uid']) && $_SESSION['ulev'] == 0) || (isset($_SESSION['uid']) && $_SESSION['ulev'] == 3)  || (isset($_SESSION['uid']) && $_SESSION['ulev'] == 1) ){
		$cid = $_SESSION['uid'];
	}
	else{
		if(isset($_GET['z'])){
...
<body>
	...
	<div class="cib">
    	<form action="actions/dofinaltranscript.php" method="post" name="newstudent" target="_blank"><br />
        <table align="center">
        	<tr>
			...
			<br /><br /><input type="submit" name="buton" value="Final Transcript" /></p></div>
