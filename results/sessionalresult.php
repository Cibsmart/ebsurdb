...
<script type="text/javascript" src="resultJS.js"></script>
...
<body>
	...
	<div class="cib">
    	<form action="actions/dosessionalresult.php" method="post" name="newstudent" target="_blank"><br />
        <table align="center">
        	<tr>
            	<td align="right">Registration Number:</td>
                <td><input type="text" name="reg_no" autofocus="autofocus" autocomplete="on" onchange="loadsession(this.value)"/></td>
            </tr>
          <!--  <tr>
            	<td align="right">Session:</td>
                <td><?php //$sess = new sess();
			...
			<br /><br /><input type="submit" name="bttn_new_student" value="Check Sessional Result" /></p></div>
