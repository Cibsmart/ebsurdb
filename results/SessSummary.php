...
<title>Result Sessional Summary</title>
...
<body>
<p  align="center"><b><font size = "+2" face="Arial, Helvetica, sans-serif">Departmental/Sessional Summary</font></b></p>
<p align="center"> <img src="../images/rule.gif" width = "80%"  height="10"/></p>

<form action="actions/doSessionalSummary.php" method="post" name="form1" id="form1" target="_blank">
...
<?php		 for ($i = 1; $i <= $num_dept; $i++)
			{	$r = mysql_fetch_array($act);
				$rr = $r["Dept"];
?>
				<option value = <? echo $i ?> > <? echo $rr ?> </option>
<?php			}
?>					 
		</select>
      </label></td>
	...
	<tr>
		...
		<option value = 2003/2004 > 2002/2004 </option>
		<option value = 2004/2005 > 2003/2005 </option>
