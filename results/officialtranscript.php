...
<body>
	...
	<div class="cib">
    	<form action="actions/doofficialtranscript.php" method="post" name="newstudent" target="_blank"><br />
        <table align="center">
        	<tr>
			...
			<br /><br /><input type="submit" name="buton" value="Official Transcript" /></p></div>
