...
<body>
	...
	<div class="cib">
    	<form action="actions/doregview.php" method="post" name="newstudent"><br />
        <table align="center">
        	<tr>
            	<td align="right">Registration Number:</td>
                <td>
                <input type="text" name="reg_no" id ="reg_no" autofocus="autofocus" autocomplete="on" onchange="loadmail()" onkeyup="loadmail()"/>
                </td>
            </tr>
         </table>
        </form>
