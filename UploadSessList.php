...
<title>Course List Upload...</title>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="4" align="left" valign="middle" bgcolor="#000080"><div style="margin:0px 10px; font-weight:bold; color:#FFF; font-size:14px;" align="center">Copy and Paste Course List to be Uploaded into Sessional Course List.csv on your desktop</div></td>
    </tr>
  <tr>
    ...
    <form>
	<input type="button" value="Click to Start Uploading Course List" onclick="uploadsesslist()" />
    </form>
  	</div>
    </td>
  </tr>
